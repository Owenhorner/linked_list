...
RSpec.describe ::Circular::LinkedList do
  ...
  describe "#get_next!" do
    ...
    it "go back to beginning after traverse entire list" do
      linked_list.get_next!
      linked_list.get_next!
      expect(linked_list.get_next!).to eq(node_1)
      expect(linked_list.current).to eq(node_1)
    end
  end
  ...
  describe "#get_previous!" do
    ...
    it "traverse to last node" do
      expect(linked_list.get_previous!).to eq(node_3)
      expect(linked_list.current).to eq(node_3)
    end
  end
end
